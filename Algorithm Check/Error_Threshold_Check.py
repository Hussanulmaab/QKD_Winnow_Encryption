...
with open("../Winnow Encryption Main Algorithm/Alice_Error_Reconciliated.txt", 'r') as Alice_Sifted_bits:
    Alice_Bits = Alice_Sifted_bits.read()

with open("../Winnow Encryption Main Algorithm/Bob_Error_Reconciliated.txt", 'r') as Bob_Sifted_bits:
    Bob_Bits = Bob_Sifted_bits.read()
