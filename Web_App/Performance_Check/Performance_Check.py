...
def Performance_Check():
    ...
    with open("./Performance_Check/Transmitter_Sifted.txt", 'r') as Transmitter_Sifted_bits:
        Transmitter_Bits = Transmitter_Sifted_bits.read()

    with open("./Performance_Check/Receiver_Sifted.txt", 'r') as Receiver_Sifted_bits:
        Receiver_Bits = Receiver_Sifted_bits.read()
    ...
    with open("./Winnow_1/Transmitter_Winnow-1_Final.txt", 'r') as Transmitter_Sifted_bits:
        Transmitter_Bits = Transmitter_Sifted_bits.read()

    with open("./Winnow_1/Receiver_Winnow-1_Final.txt", 'r') as Receiver_Sifted_bits:
        Receiver_Bits = Receiver_Sifted_bits.read()
